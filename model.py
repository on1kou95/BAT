...
import torch
import torchvision
from r3d_classifier import r3d_18_classifier,r2plus1d_18
...
def build_r3d_classifier(num_classes = 4, kin_pretrained = False, self_pretrained = True, saved_model_file = None, linear = True):
...
def load_r3d_classifier(num_classes = 4, saved_model_file = None):
